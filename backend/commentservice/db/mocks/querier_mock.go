...
func (m *MockQuerier) GetAllCommentsByUserPaginated(ctx context.Context, arg db.GetAllCommentsByUserPaginatedParams) ([]db.CommentserviceComment, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAllCommentsByUserPaginated", ctx, arg)
	ret0, _ := ret[0].([]db.CommentserviceComment)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockQuerier) GetCommentByID(ctx context.Context, arg db.GetCommentByIDParams) (db.CommentserviceComment, error) {
	m.ctrl.T.Helper()
...
func (m *MockQuerier) GetCommentsByVideo(ctx context.Context, videoID string) ([]db.CommentserviceComment, error) {
	m.ctrl.T.Helper()
...
func (m *MockQuerier) GetCommentsByVideoPaginated(ctx context.Context, arg db.GetCommentsByVideoPaginatedParams) ([]db.CommentserviceComment, error) {
	m.ctrl.T.Helper()
...
func (m *MockQuerier) GetRepliesByCommentID(ctx context.Context, commentID sql.NullString) ([]db.CommentserviceComment, error) {
	m.ctrl.T.Helper()
...
func (m *MockQuerier) ListComments(ctx context.Context) ([]db.CommentserviceComment, error) {
	m.ctrl.T.Helper()
