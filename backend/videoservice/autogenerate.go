...
// //go:generate protoc --ts_opt=no_namespace --ts_opt=unary_rpc_promise=true --ts_opt=target=web --ts_out=../../frontend/mobileapp/src/proto/ --proto_path=../../proto videoservice.proto
...
// //go:generate sh -c "sed -i  's|@grpc/grpc-js|grpc-web|g' ../../frontend/mobileapp/src/proto/videoservice.ts"

// This to avoid any errors during `npm run build`
// //go:generate sh -c "sed -i '1i\\// @ts-nocheck' ../../frontend/mobileapp/src/proto/videoservice.ts"
